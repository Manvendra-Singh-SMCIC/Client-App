...
class EnterReferralCode extends StatefulWidget {
  const EnterReferralCode({Key? key, required this.id}) : super(key: key);

  final int id;

  @override
  _EnterReferralCodeState createState() => _EnterReferralCodeState();
}

class _EnterReferralCodeState extends State<EnterReferralCode> {
  @override
                    ...
                    if (!validating && controller.text.trim().isNotEmpty) {
                      ...
                      FirebaseFirestore.instance
                        ...
                        if (documentSnapshot.exists) {
                          ...
                          if (!used_by.contains(widget.id)) {
                            used_by.add(widget.id);
                          }
