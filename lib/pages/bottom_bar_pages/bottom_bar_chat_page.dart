...
import 'package:client_app_amacle_studio/pages/bottom_bar_pages/chat.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: SafeArea(child:
          Consumer<PageRebuilder>(builder: (context, pageRebuilder, child) {
                                      ...
                                      return FutureBuilder<List<ChatData>>(
                                          ...
                                          builder: (context, snapfinal) {
                                            if (snapfinal.hasData) {
                                              log(snapfinal.data!.length
                                                  .toString());
                                              if (snapfinal.data!.length != 0) {
                                                return ListView.builder(
                                                    itemCount:
                                                        snapfinal.data!.length,
                                                    // itemCount: 0,
                                                    itemBuilder:
                                                        (context, index) {
                                                      // print(snapfinal.data);

                                                      int userId = snapfinal
                                                          .data![index].id;
                                                      // log(userId.toString());
                                                                  ...
                                                                  ListTile(
                                                                    ...
                                                                    subtitle:
                                                                      ...
                                                                      children: [
                                                                        Visibility(
                                                                          visible:
                                                                              snapfinal.data![index].lastChatData["sender_id"] == Global.id,
                                                                          child:
                                                                              Icon(
                                                                            snapfinal.data![index].lastChatData["seen_by_other"] == "yes"
                                                                                ? Icons.done_all
                                                                                : Icons.done,
                                                                            color:
                                                                                black,
                                                                        ...
                                                                        addHorizontalySpace(
                                                                            4),
                                                                        Text(
                                                                          snapfinal.data![index].lastChatData["type"] == "text"
                                                                              ? snapfinal.data![index].lastChatData["message"]
                                                                    ...
                                                                    trailing:
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          snapfinal.data![index].lastChatData["last_time"] == null
                                                                              ? ""
                                                                              : DateFormat('d MMMM y').format(DateTime.parse(snapfinal.data![index].lastChatData["last_time"].toDate().toString().split(' ')[0])),
                                                                          style:
                                                                              TextStyle(
                                                                            fontSize:
                                                                                8.5,
                                                                        ...
                                                                        Text(
                                                                          snapfinal.data![index].lastChatData["last_time"] == null
                                                                              ? ""
                                                                              : DateFormat('h:mm a').format(snapfinal.data![index].lastChatData["last_time"].toDate()),
                                                                          style:
                                                                              TextStyle(
                                                                            fontSize:
                                                                                8.5,
                                                                        ...
                                                                        Visibility(
                                                                          visible:
                                                                              snapfinal.data![index].lastChatData["seen"] == "no",
                                                                          child:
                                                                              Container(
                                                                            width:
                                                                                10,
