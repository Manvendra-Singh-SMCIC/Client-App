                        ...
                        onPressed: () async {
                          if (check() &&
                            ...
                            if (checkBox) {
                              ...
                              String folderPathpic = 'images/';
                              String fileNamepic = DateTime.now()
                                      .millisecondsSinceEpoch
                                      .toString() +
                                  '_' +
                                  ProfileData.pic!.path.split('/').last;

                              FirebaseStorage storagepic =
                                  FirebaseStorage.instance;
                              Reference refpic = storagepic
                                  .ref()
                                  .child(folderPathpic + fileNamepic);
                              UploadTask uploadTaskpic =
                                  refpic.putFile(ProfileData.pic!);
                              ...
                              // nextScreen(context, EnterReferralCode());

                              gotoNext(context, count + 1);
